        ...
        <table>
            ...
            <?php foreach ($applications as $app): ?>
                <tr>
                    ...
                    <td>
                    <?php if (!empty($app['resume']) && file_exists('resumes/' . basename($app['resume']))): ?>
    <a href="resumes/<?php echo basename($app['resume']); ?>" target="_blank" class="resume-link">View Resume</a>
<?php else: ?>
